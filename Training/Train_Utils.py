...
from Train_Model import preprocess_true_boxes, yolo_body, yolo_loss
...
def get_random_data(annotation_line, input_shape, random=True, max_boxes=20, jitter=.3, hue=.1, sat=1.5, val=1.5, proc_img=True):
    line_temp = annotation_line.split('.jpg')
    line_temp[0] += ".jpg"
    line_split = line_temp[1].split()
    line_split.insert(0, line_temp[0])
    line = line_split
